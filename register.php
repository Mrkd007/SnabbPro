<?php
	...
	if ( isset($_POST['btn-signup']) ) {
		...
		if (empty($phone)){
			...
			$error = true;
			$phoneError = "Phone Number must have atleast 10 digits.";
		}
		// password validation
		if (empty($pass)){
			$error = true;
		...
		if( !$error ) {
			...
			$query = "INSERT INTO users(userName,userPhone,userEmail,userPass) VALUES('$name','$phone','$email','$password')";
...
<title>Register with SnabbPro</title>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	...
            	<input type="text" name="phone" class="form-control" placeholder="Enter 10 digit Phone Number" maxlength="10" value="<?php echo $phone ?>" required="" />
                </div>
